...
excluded_artists = [
    "Simon & Garfunkel", "Hall & Oates", "Crosby, Stills & Nash", "Crosby, Stills, Nash & Young", 
    "Earth, Wind & Fire", "Emerson, Lake & Palmer", "Ike & Tina Turner", "Bell Biv DeVoe", 
    "Huey, Dewey & Louie", "Peter, Paul & Mary", "Chad & Jeremy", "Ashford & Simpson", 
    "Derek & The Dominos", "Peaches & Herb", "Brooks & Dunn", "She & Him", "Big Boi & Dre", 
    "Sonny & Cher", "The Captain & Tennille", "Salt-N-Pepa", "The Mamas & the Papas", 
    "Gladys Knight & the Pips", "Yoko & the Plastic Ono Band", "Marilyn & Billy", 
    "David Crosby & Graham Nash", "Loggins & Messina", "Sam & Dave", "David & David", 
    "Macklemore & Ryan Lewis", "Richard & Linda Thompson", "Captain Beefheart & His Magic Band", 
    "James & Bobby Purify", "Peter, Bjorn & John", "Pat Travers Band & Carmine Appice", 
    "Adam & The Ants", "England Dan & John Ford Coley", "George & Tammy", 
    "Dr. Buzzard's Original Savannah Band", "Boots Randolph & His Combo", "Louis Prima & Keely Smith", 
    "Sly & Robbie", "Sonny Terry & Brownie McGhee", "Booker T. & the MG's", "Meat Loaf & Stoney", 
    "Nino Tempo & April Stevens", "Ruth Brown & Clyde McPhatter", "The Clark Sisters & Mattie Moss Clark", 
    "Hank Ballard & the Midnighters", "El Chicano & Poncho Sanchez", "Bob Seger & the Silver Bullet Band", 
    "Adam & The Ants", "Duke Ellington & His Orchestra", "Tony Bennett & Lady Gaga", 
    "Charles Brown & Amos Milburn", "George Clinton & Parliament-Funkadelic", "Ike & Tina Turner", 
    "Dr. Hook & The Medicine Show", "Lester Flatt & Earl Scruggs", "Kool & The Gang", 
    "Fred Astaire & Ginger Rogers", "Les Paul & Mary Ford", "Louis Armstrong & His All-Stars", 
    "Peter & Gordon", "Mickey & Sylvia", "Sam & Dave", "The Mamas & the Papas", 
    "Meat Loaf & Ellen Foley", "Xscape & Jermaine Dupri", "Simon & Garfunkel", 
    "Crosby, Stills & Nash", "Crosby, Stills, Nash & Young", "Earth, Wind & Fire", 
    "Ashford & Simpson", "Lionel Hampton & His Orchestra", "Shirley & Lee", 
    "LaVern Baker & Jimmy Ricks", "George Jones & Tammy Wynette", "Ike & Tina Turner", 
    "Brooks & Dunn", "Elvis Costello & the Attractions", "Martha & The Vandellas", 
    "Ike & Tina Turner", "Prince & The Revolution", "George Michael & Elton John", 
    "Prince & The New Power Generation", "Booker T. & the MG's", "Rufus & Chaka Khan", 
    "Sonny & Cher", "Sergio Mendes & Brasil '66", "Ziggy Marley & The Melody Makers", 
    "Robert Plant & Alison Krauss", "Captain Beefheart & His Magic Band", "Peaches & Herb", 
    "Lionel Richie & Diana Ross", "Dr. Hook & The Medicine Show"
]
